...
adminlte.run(['$rootScope', '$location', function ($rootScope, $location) {
    ...
    $rootScope.loadheader    = false;
    $rootScope.loadside      = false;
    $rootScope.loadfooter    = false;
    $rootScope.loadview      = false;
    $rootScope.$on("$includeContentLoaded", function(event, templateName){
        if (templateName == "view/layouts/header.html") {
            $rootScope.loadheader = true;
        } else if (templateName == "view/layouts/sidebar.html") {
            $rootScope.loadside = true;
        } else if (templateName == "view/layouts/footer.html") {
    ...
    $rootScope.$on("$viewContentLoaded", function() {
        $rootScope.loadview = true;
        $rootScope.jqinit();
    });

    $rootScope.jqinit = function() {
        if ($rootScope.loadheader == false ||
            $rootScope.loadside   == false ||
            $rootScope.loadfooter == false ||
            $rootScope.loadview   == false) {
            return;
